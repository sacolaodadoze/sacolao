...
export const schema = z.object({
  ...
  document: z.string().min(1, LANG.GLOBAL.REQUIRED),
  name: z.string().min(1, LANG.GLOBAL.REQUIRED),
  phone_p: z.string().min(1, LANG.GLOBAL.REQUIRED),
  phone_s: z.string().optional(),
  observations: z.string().optional(),
  cep_1: z.string().optional(), //z.string().min(8, LANG.GLOBAL.REQUIRED),
